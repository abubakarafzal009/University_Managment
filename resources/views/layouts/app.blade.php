    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @endrole
                <li class=" nav-item"><a href="{{url('CourseDetail')}}"><i class="fa fa-info-circle"></i><span class="menu-title" data-i18n="Profile">Course</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('StudentProgress')}}"><i class="fa fa-building-o"></i><span class="menu-title" data-i18n="FAQ">Student Progress</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('ContactPerson')}}"><i class="fa fa-phone"></i><span class="menu-title" data-i18n="Knowledge Base">Student Course</span></a>
                </li>
