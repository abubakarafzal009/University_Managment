...
<div class="card">
        ...
        <form class="form form-vertical" method="POST" action="{{ route('Company.update',$role->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="wrap-indirizzo_carico">
                            <input name="address" type="text" class="form-control input-sm" value="{{$role->address}}"
                    ...
                    <div class="form-group row">
                            ...
                            <option
                            @if($item->id==$role->status)
                            selected
                             value="{{$item->id}}"
                             @endif
                             >{{$item->company_status}}</option>
