...
<div class="content-body">
        ...
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">ContactPerson</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a>
                            </li>
                            <li class="breadcrumb-item active">ContactPerson
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <a href="{{url('ContactPerson/create')}}" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i></a>
        </div>
       @endrole
    </div>
                    <!-- DataTable starts -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm zero-configuration">
                                    ...
                                    @else
                                        ...
                                        <td>
                                                        <a href="{{route('ContactPerson.edit',$use->id)}}" class=""><i
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                    <form action="{{route('ContactPerson.destroy', $use->id)}}" method="POST">
